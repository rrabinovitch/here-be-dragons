...
class NytimesTest < Minitest::Test
  ...
  def test_it_can_get_all_stories_with_subsection_of_politics
    ...
    assert_equal "Congressional G.O.P. Agenda Quietly Falls Into Place Even as Trump Steals the Spotlight", result.first[:title]
    assert_equal "Conspiracy Theories Made Alex Jones Very Rich. They May Bring Him Down.", result.last[:title]
  end
